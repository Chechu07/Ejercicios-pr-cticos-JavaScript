...
function chooseDish(choose) {
  if(choose === 1) {
    return 'Eligio el plato 1 y su valor es de $3500'
  }else if(choose === 2) {
    return 'Eligio el plato 2 y su valor es de $4000'
  }else if(choose === 3) {
    return 'Eligio el plato 3 y su valor es de $3000'
  }else{
